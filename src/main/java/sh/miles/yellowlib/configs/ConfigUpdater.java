...
public final class ConfigUpdater {
     ...
     * @param resourceName    The yaml file name to update from, typically
     *                        config.yml
     * @param toUpdate        The yaml file to update
     * @param ignoredSections List of sections to ignore and copy from the current
     *                        config
    ...
    public static void update(Plugin plugin, String resourceName, File toUpdate, List<String> ignoredSections)
        ...
        FileConfiguration newConfig = YamlConfiguration
                .loadConfiguration(new InputStreamReader(plugin.getResource(resourceName)));
    ...
    // It checks if key has a comment associated with it and writes comment then the
    // key and value
    ...
    private static void write(Object obj, String actualKey, String prefixSpaces, Yaml yaml, BufferedWriter writer)
            throws IOException {
    ...
    private static void writeList(List<String> list, String actualKey, String prefixSpaces, Yaml yaml,
